...
public class Partie {
  ...
  public static class Score {
    ...
    public Score(Opposants opposants) {
      for (var i = 0; i < opposants.toutesEquipes().size() ; i++)
      {
        this.manchesGagneesParEquipe.put(opposants.toutesEquipes().get(i), 0);
      }
    }
    ...
    public Map<Equipe, Integer> manchesGagneesParEquipe() { return manchesGagneesParEquipe; }
